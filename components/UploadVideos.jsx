    ...
    <div className="max-w-md mx-auto p-6 bg-gradient-to-r from-gray-800 via-gray-900 to-orange-400 text-white rounded-lg shadow-lg">
      <div className="mt-20">
        <Link href="/upload-to-blog">
          <button className="bg-gradient-to-r from-gray-700 via-gray-800 to-orange-400 hover:bg-gray-800 text-white font-semibold px-4 py-1 rounded transition duration-200 border border-black">
            Upload Blog
          </button>
        </Link>
      </div>
      <h1 className="text-2xl font-bold mb-10 text-center mt-10">
        Add New Video
      </h1>
