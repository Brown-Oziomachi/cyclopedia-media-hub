    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 lg:py-24 lg:mt-20 mt-10 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-950/20 dark:to-indigo-950/20">
        <div className="container mx-auto px-6 text-center max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-purple-100 dark:bg-purple-900/30 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-semibold uppercase tracking-wider text-purple-700 dark:text-purple-300">Get In Touch</span>
          </div>
      ...
      <section className="container mx-auto px-6 py-16 lg:py-24">
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-600 to-indigo-600 rounded-2xl p-8 text-white shadow-xl">
              ...
              <p className="leading-relaxed opacity-95">
                A trusted platform for curated insights, investigative journalism, and evidence-based information. Join us in building a global system of knowledge and transparency.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              {/* Phone */}
              <div className="bg-purple-50 dark:bg-purple-900/10 rounded-xl p-6 hover:shadow-lg transition-all hover:scale-[1.02]">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm opacity-60 mt-1">Mon-Fri, 9AM - 6PM WAT</p>
                  </div>
                </div>
              </div>

              {/* Email */}
              <div className="bg-indigo-50 dark:bg-indigo-900/10 rounded-xl p-6 hover:shadow-lg transition-all hover:scale-[1.02]">
                <div className="flex items-start gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-indigo-600 dark:text-indigo-400 font-medium">Chat with our team</span>
                    </div>
                    <p className="text-sm opacity-60 mt-1">Instant support available</p>
                  </div>
                </div>
              </div>
            ...
            {/* Business Hours */}
            <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900/30 dark:to-slate-800/30 rounded-xl p-6 shadow-md">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-purple-600 dark:text-purple-400">9:00 AM - 6:00 PM</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="opacity-70">Saturday</span>
                  <span className="font-semibold text-purple-600 dark:text-purple-400">10:00 AM - 4:00 PM</span>
                </div>
                <div className="flex justify-between items-center">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white dark:bg-slate-900/50 rounded-2xl p-8 lg:p-12 shadow-2xl">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="browncode@example.com"
                      className="w-full p-4 rounded-lg bg-slate-50 dark:bg-slate-800/50 focus:ring-2 focus:ring-purple-500 focus:bg-white dark:focus:bg-slate-800 transition outline-none"
                    />
                    {errors.email && (
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="opacity-70 text-lg">
              The Cyclopedia is committed to transparency, accuracy, and meaningful connections.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center p-6 bg-white dark:bg-slate-900/50 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="opacity-70">
                A reliable source for investigative journalism and curated insights.
              </p>
            </div>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-6">
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-10 text-center shadow-2xl max-w-md w-full">
            <div className="inline-flex p-4 rounded-full bg-green-100 dark:bg-green-900/30 mb-6">
              <ThumbsUp className="text-green-600 dark:text-green-400" size={40} />
            </div>
      ...
      <footer className="py-12 bg-slate-900 dark:bg-slate-950 text-white">
        <div className="container mx-auto px-6 text-center">
          <p className="font-semibold mb-2">© 2025 The Cyclopedia</p>
          <p className="opacity-70 text-sm mb-4">Truth. Light. Clarity.</p>
          <a
            href="/"
            className="text-purple-400 hover:text-purple-300 transition font-semibold"
          >
            www.thecyclopedia.com.ng
          </a>
        </div>
      </footer>
    </main>
