    ...
    <>
            ...
            <div className="space-y-2 absolute">
              ...
              <h1 className="text-4xl font-bold lg:text-7xl text-gray-400 -mt-80">
                ...
                <span className="text-orange-400">
                  {" "}
                  CREA<span className="text-orange-300">TION</span>
                </span>
              </h1>
              {/* The Sun Web Title */}
              <div className="flex items-center justify-center ">
                ...
                <h1 className="text-5xl font-bold text-white max-md:text-2xl flex items-center justify-center border border-{animate-ping} border-orange-400 border-r-white border-b-white py-2 px-10 bg-gray-900 rounded-md gap-5">
                  ...
                  <span className="text-orange-400 "> | Sun </span>Web |
                </h1>
              </div>

              {/* Description Text */}
              <p className="text-lg lg:text-2xl text-gray-300 max-w-3xl mx-auto max-md:w-1/2">
                "Where the <span className="text-orange-400">Sun</span> Meets
                Your Vision"
              </p>
              ...
              <div className="flex justify-center gap-4 mt-2 group">
                <Link href="/contact">
                  <button className="bg-gray-400/5 border-x cursor-pointer hover:text-xl flex gap-2 hover:bg-white hover:text-black text-white px-6 py-3 rounded-lg font-semibold transition-all shadow-lg group-hover:bg-white group-hover:text-black ">
                    Get Started
                    <ArrowRightToLine />
                  </button>
                </Link>
                <Link href="/about">
                  <button className="bg-gray-400/5 border-y cursor-pointer hover:text-xl flex gap-2 hover:bg-white hover:text-black text-white px-6 py-3 rounded-lg font-semibold transition-all shadow-lg group-hover:bg-white group-hover:text-black ">
                    Learn More
                    <ChevronRight />
                  </button>
                </Link>
      ...
      <div className="py-2 bg-gray-400/5 text-center lg:flex items-center justify-center">
        ...
        <div className="lg:grid lg:space-y-10 lg:mt-50">
          ...
          <div className="text-lg text-gray-400 mx-auto mb-1 border-b border-x">
          ...
          <Link href="/contact" className="cursor-pointer">
            <button className="mb-10 shadow-2xl flex mx-auto gap-2 cursor-pointer hover:bg-white hover:text-black hover:animate-pulse text-white px-8 py-4 text-lg rounded-lg font-bold border-x transition-all">
              Connect
      ...
      {/* ACTION SECTION */}
      <div className="mx-auto px-6 lg:px-50 py-16 bg-gray-400/10 border border-white shadow-[0_0_40px_10px_rgba(255,165,0,0.3)] rounded-lg">
        ...
        <p className="py-2 text-center text-gray-400">
          ...
          <Link href={session ? "/registration" : "/auth/signin"}>
            <p className="text-yellow-500 hover:text-cyan-400 underline ">
      ...
      <div className=" py-1 overflow-hidden z-50">
        ...
        {[
          ...
          <div
            key={index}
            className="bg-gray-400/10 z-0 p-5 -mt-15 rounded-lg flex flex-col items-center justify-center shadow-lg shadow-orange-500 transition border-l-4 border-black mb-10 "
          >
            ...
            <div className="flex text-xs gap-4 group">
              {item.buttons.map((button, i) => (
                <Link key={i} href={button.href}>
                  <p className="group-hover:text-black px-4 py-2 bg-gray-400/5 border-x text-white hover:text-white rounded-lg font-semibold hover:bg-orange-600 transition flex items-center gap-1">
      ...
      <div className="container mx-auto px-6 py-16">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {item.buttons.map((button , btnIndex) => (
                  <Link key={btnIndex} href={button.href} >
                    <p className="flex gap-1 cursor-pointer px-4 py-2 bg-gray-400/5 border-x hover:bg-orange-600 text-white font-medium rounded-full shadow-md transition duration-300">
        ...
        <div id="services"></div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10  w-full rounded-lg shadow-lg">
            {[
              ...
              >
                <div className="group-hover:animate-bounce m-5 text-white">
                  {service.icon}
                </div>
                {service.img && (
                  <img
        ...
        <div>
          ...
          <p className="text-center text-gray-500 text-sm cursor-pointer">
