    ...
    <>
          ...
          <main className="flex flex-col justify-center items-center h-80 lg:h-200 text-center px-4 lg:px-0 ">
            <div className="space-y-2 ">
              ...
              <h1 className="text-4xl font-bold lg:text-7xl max-md:mr-30 text-gray-600 max-md:mt-30">
                WEBWIZ{" "}
                <span className="text-orange-400 max-md:ml-50">CREATION</span>
              </h1>
            ...
            <div className="flex gap-1 mt-2">
              <Link
                href="/youtubevideos"
                className="flex gap-1 bg-gradient-to-r from-gray-900 via-black to-orange-400 text-white px-10 py-3 rounded-lg hover:bg-blue-600 shadow-lg transition-transform duration-300 ease-in-out transform hover:scale-105 cursor-pointer"
              >
                Watch Video
                <Play />
              </Link>
      ...
      <div className=" mx-auto px-6 lg:px-50 py-16 bg-black  outline-1 outline-white  border-amber-600 shadow-2xl shadow-amber-700">
        ...
        <div className="text-center text-gray-300 lg:text-xl  mx-auto text-base ">
          WebWiz isn’t just a platform; it’s a radiant space where the
          brilliance of innovation meets opportunity. Like the sun illuminating
          all it touches, WebWiz empowers developers, innovators, and
          collaborators to shine. Connect with talent, showcase skills, and
          create revolutionary ideas that light up your business..
        </div>

        <div className=" mx-auto px- lg:px-20 ">
          <div className="text-center text-gray-300 lg:text-xl">
            <div className="py-2">
              WebWiz is your gateway to cutting-edge technology and creative
              innovations. We bring the warmth and energy of sunlight to
              individuals, businesses, and organizations striving to thrive in
              the digital era. Our dynamic solutions help your vision flourish
              and illuminate new possibilities.
            </div>
            <div className="py-2">
              Whether you're a developer seeking collaboration or a business
              searching for talent, WebWiz is the sunlit hub for endless
              opportunities and revolutionary ideas. Let us brighten your
              journey toward success.
              <Link href="/registration">
                <p className="text-yellow-600 hover:text-white underline ">
                  Register <span className="hover:text-cyan-400"> here!</span>
                </p>
              </Link>
            </div>
          </div>
      ...
      <div className="container mx-auto px- lg:px-2 py-16">
        ...
        <p className="text-center text-gray-400 text-lg max-w-3xl mx-auto mb-12 leading-relaxed">
          ...
          and digital strategy. Let us help you unlock your potential in the
          digital realm.
        </p>
            ...
            <section className=" b mt-20 bg-orange-400 shadow-[0_0_80px_40px_rgba(255,165,0,0.8)] animate-pulse">
              <div className="container mx-auto px-5 lg:px-20 text-center bg-black py-20 ">
                ...
                <p className="text-lg text-gray-300 lg:w-2/3 mx-auto leading-relaxed">
                  Webwiz isn't just a platform for developers; it's a space
                  where you can uncover talent, collaborate, and thrive. Connect
                  with developers across diverse specialties and turn innovative
                  ideas into reality.{" "}
                  <Link href="/registration">
