...
const TermsOfService = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 py-30text-gray-400/5 rounded-lg shadow-lg text-white">
      <h1 className="text-4xl font-extrabold mb-8 text-white mt-20 text-center brightness-200">Terms of Services</h1>
      
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-green-600">1. Introduction</h2>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-green-600">2. Use of Our Website</h2>
        <p className="text-gray-300 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-green-600">3. Intellectual Property</h2>
        <p className="text-gray-300 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-green-600">4. User Content</h2>
        <p className="text-gray-300 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-green-600">5. Accounts and Registration</h2>
        <p className="text-gray-300 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-green-600">6. Changes to Terms</h2>
        <p className="text-gray-300 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-green-600">7. Contact Us</h2>
        <p className="text-gray-300 leading-relaxed">
          If you have any questions about these Terms of Service, please contact us at{' '}
          <Link href="mailto:support@webwizcreation.com">
            <p className="text-green-600 hover:text-cyan-600 underline">support@webwizcreation.com</p>
          </Link>
          .
        </p>
      </section>
