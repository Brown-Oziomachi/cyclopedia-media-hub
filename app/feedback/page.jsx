    ...
    <div className="min-h-screen py-12 px-4 md:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center mb-4 p-3 mt-10 lg:mt-50 bg-purple-500/10 rounded-full border border-purple-500/20">
                    ...
                    <label
                      ...
                      className={`relative flex flex-col items-center p-5 rounded-2xl cursor-pointer transition-all duration-300 shadow-2xl ${
                        isSelected
                          ...
                          : "border-gray-750 hover:border-gray-600 hover:bg-gray-800/"
                      }`}
                    >
                      <input
                        type="radio"
                      ...
                      <p className="text-xs text-center mt-1">{option.desc}</p>
                    </label>
                  );
                })}
              </div>
      ...
      {popup && submitData && (
        <div className="fixed inset-0 bg-black/80 text-white backdrop-blur-lg flex items-center justify-center z-50 p-4">
          <div
            ref={popupDataRef}
          ...
          >
            <button
              ...
              className="absolute top-4 right-4 hover:bg-gray-800/50 rounded-lg p-2"
            >
              <X size={24} />
            </button>
            ...
            <p className="text-center mb-6 text-sm md:text- text-white">
            ...
            <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 border border-gray-700/50 rounded-2xl p-4 md:p-6 mb-6 space-y-3">
              <div className="flex justify-between items-start pb-3 border-b border-gray-700/50 gap-2">
                ...
                <span className="font-semibold capitalize bg-purple-500/20 px-2 py-1 rounded-lg text-xs">
              ...
              <div>
                <span className="font-medium text-sm block mb-2">Message:</span>
