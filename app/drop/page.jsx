  ...
  return (
    <section className="px-6 py-16 bg-gradient-to-t from-black text-center grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
      <div className="mt-20">
        ...
        <Link href="/">
          <h2 className="text-xl font-bold text-white text-left hover:underline">
            Britain’s secret state and the need for whistle-blowing
          </h2>
        </Link>
        <p className="text-sm text-gray-500 text-left mt-5 mask-b-from-10%">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 text-left mt-5 mask-b-from-20%">
