...
export default function UserProfile() {
    ...
    const viewingUserId = searchParams.get("id"); // View other user's profile
    ...
    const joinedDate = new Date(profileData?.createdAt).toLocaleDateString();
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 flex-1 min-w-0">
                            ...
                            {!isEditing ? (
                                <div className="text-center sm:text-left flex-1 min-w-0">
                                    ...
                                    {profileData?.bio && (
                                        <p className="text-gray-700 mt-2 text-sm">{profileData.bio}</p>
                                    )}
