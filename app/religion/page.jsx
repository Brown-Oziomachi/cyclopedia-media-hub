  ...
  return (
    <main className="w-full bg-white">
      ...
      {loading ? (
        ...
        <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {posts.map((post) => (
            <div
              key={post.id}
              className="relative focuse-ring-purple-600 hover:purple-600 hover:shadow-purple-600 hover:shadow-2xl"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        {/* ✅ Keep adding your static cards below unchanged */}
        {/* ... (rest of your static religion cards) ... */}
      </div>
