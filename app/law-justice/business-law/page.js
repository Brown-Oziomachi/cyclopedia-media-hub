...
const BusinessPage = () => {
    ...
    useEffect(() => {
        const fetchBusinessPosts = async () => {
            try {
                ...
                console.log("Fetched Business posts:", data);
                setPosts(data);
            } catch (error) {
    ...
    return (
        <main className="w-full">
            <section className="relative w-full h-[500px] flex items-center justify-center text-center bg-gradient-to-br from-blue-700 via-indigo-700 to-purple-800 overflow-hidden">
                {/* Background Overlays */}
                <div className="absolute inset-0 bg-black/30"></div>
                <div className="absolute w-[400px] h-[400px] bg-indigo-600/40 blur-3xl rounded-full top-10 left-20 animate-pulse"></div>
                <div className="absolute w-[300px] h-[300px] bg-purple-600/40 blur-3xl rounded-full bottom-10 right-20 animate-pulse delay-1000"></div>
                ...
                <div className="relative z-10 px-4 lg:mt-30">
                    ...
                    <p className="text-gray-100 max-w-2xl mx-auto text-sm md:text-lg leading-relaxed">
                        Comprehensive guidance on business formation, corporate law, contracts, and all legal matters affecting Nigerian entrepreneurs and businesses.
                    </p>
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 lg:py-40 py-20">
                                ...
                                <div className="relative rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                                    <div className="flex gap-3 p-4">
                                        ...
                                        <div className="flex-1">
                                            <h3 className="text-base font-bold line-clamp-3 hover:text-blue-600 transition-colors">
                                                {post.title}
                                            </h3>
                                        </div>
                                    </div>
                ...
                <div className="mx-auto text-center mt-16 mb-16 bg-gradient-to-r from-blue-700 to-indigo-700 text-white py-14 px-6 rounded-2xl shadow-xl max-w-3xl">
                    <h2 className="text-3xl font-extrabold mb-3">
                        Navigate Business Legal Matters
                    </h2>
                <p className="text-base md:text-lg text-gray-200 mb-6">
                    Stay informed with expert advice on business formation, corporate compliance, contracts, and entrepreneurship in Nigeria.
                </p>
            ...
            {loading ? (
                <p className="text-center py-10">Loading business posts...</p>
            ) : posts.length === 0 ? (
                <p className="text-gray-500 text-center">
                    No business posts found. Check back soon for updates.
                </p>
            ) : (
