...
export default function AllLegalIssues() {
    ...
    // Practice areas for the directory section
    const practiceAreas = [
    ...
    return (
        <main className="w-full">
            ...
            {/* Directory Search Experience Section */}
            <div className="bg-gray-50 py-16 px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    {/* Practice Areas Grid */}
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-6 max-w-5xl mx-auto">
                        {practiceAreas.map((area, index) => (
                            <Link href={area.link} key={index}>
                                <div className="flex items-center gap-2 text-blue-700 hover:text-blue-900 transition-colors group cursor-pointer">
                                    <svg
