...
const VideoPage = () => {
  ...
  // Fallback if video cannot be embedded
  if (!isDirectVideo && !embedUrl.includes("youtube.com/embed")) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-black text-white px-4">
        <p className="text-lg font-semibold">
          Unsupported video format or broken link
        </p>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-black text-white px-6 py-12 flex flex-col items-center max-w-4xl mx-auto">
      ...
      <p className="mt-4 rounded-lg text-gray-400 leading-relaxed tracking-widest">
        {decodedDesc}
      </p>
