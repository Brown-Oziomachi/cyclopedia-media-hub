...
<p className="text-sm lg:text-base text-center text-gray-700 max-w-3xl mx-auto">
  Discover breakthroughs shaping our future — AI, space travel, biotechnology, and more. Dive into the wonders and ethical questions of the modern age.
</p>
...
Science or Academic Atheism?
            ...
            <p className="text-xs text-gray-800 mt-1">Published on August 8, 2011</p>
            <p className="mt-2 text-gray-900 text-xs">
             What happens when we give scientists the authority to speak about God?
            </p>
          </div>
        </div>
...
Healed and Whole Forever: On Psychedelic Science & Spirituality
            ...
            <p className="text-xs text-gray-800 mt-1">Published on January 25, 2016</p>
            <p className="mt-2 text-gray-900 text-xs">
Published on January 25, 2016
Patricia Kubala explores the connection between drugs, healing, and spirituality online.
            </p>
          </div>
        </div>
...
Christian Science as Jewish Tradition
            ...
            <p className="text-xs text-gray-800 mt-1">by 
Noah Berlatsky
Published on June 11, 2024</p>
            <p className="mt-2 text-gray-900 text-xs">
